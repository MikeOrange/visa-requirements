"""
Django settings for visarequirements project.
...
SECRET_KEY = 'o4-yg*i6qst&2v-v$s06ts!=(&ast6*03w+7a9^d548hbx%asg'
...
ROOT_URLCONF = 'visarequirements.urls'
...
WSGI_APPLICATION = 'visarequirements.wsgi.application'
